		...
		<div class="message-box">
			...
			<div class="right">
				<h2>Message envoyé, à bientot!</h2>
					<div class="message">
				<p>Merci <?php echo $_POST['user_name']; ?> de m'avoir contacté à propos de “<?php echo $_POST['message_subject']; ?>”.<br>

					Je reviendrai vers vous via email à l’adresse <?php echo $_POST['user_email']; ?> ou par téléphone au <?php echo $_POST['user_phone']; ?> dans les plus brefs délais pour traiter votre demande : <br>
